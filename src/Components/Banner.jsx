                ...
                <div className="px-[10px] sm:px-[30px]">
                    <div className="grid grid-cols-12">
                        <div className="col-span-12 md:col-span-7">
                            <h1 className='text-[30px] md:text-[40px] max-w-[530px] text-white font-light leading-[1.2] mb-2'>Creating <span className='font-extrabold text-[#45E2A1] gilroy-b'>100%</span> Original Custom Website Designs</h1>
                            <p className='text-white text-[15px] font-light pb-8'>Frustrated by underperforming web designs? It's time for a change and we can help. Website Design Hub is trusted by businesses nationwide. We are a top-rated and affordable web design company, known for creating websites that are:</p>
