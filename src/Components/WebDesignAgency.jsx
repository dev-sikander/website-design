    ...
    return (
        <section className='py-[90px] sm:pt-[130px] sm:pb-[80px] bg-[#F1F1F1] group'>
            <div className="px-[10px] sm:px-[30px]">
                    ...
                    <div className="grid grid-cols-12 md:grid-cols-5 gap-y-5 md:gap-y-0 sm:gap-x-4 mt-10 lg:mt-14">
                        <div className="col-span-12 sm:col-span-6 md:col-span-1 relative lg:left-[100%] group-hover:left-0 transition-all duration-700 hover:scale-90">
                            <Link href="/logo-design-company" className="relative">
                                ...
                                <div className="txt bg-[#000]/40 absolute top-0 left-0 w-full h-full flex items-center justify-center rounded-full overflow-hidden transition-all ease-in-out duration-1000 opacity-0 group-hover:opacity-100 group-hover:w-full scale-0 group-hover:scale-100">
                                    <h6 className='xl:text-[30px] text-[16px] gilroy-b text-center text-white leading-[8] lg:leading-[10] xl:leading-[12] opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all ease-in-out duration-700'>
                                        Logo Design
                                    </h6>
                                </div>
                            </Link>
                        ...
                        <div className="col-span-12 sm:col-span-6 md:col-span-1 relative lg:left-[50%] group-hover:left-0 transition-all duration-700 hover:scale-90">
                            <Link href="/logo-design-company" className="relative">
                                ...
                                <div className="txt bg-[#000]/40 absolute top-0 left-0 w-full h-full flex items-center justify-center rounded-full overflow-hidden transition-all ease-in-out duration-1000 opacity-0 group-hover:opacity-100 group-hover:w-full scale-0 group-hover:scale-100">
                                    <h6 className='xl:text-[30px] text-[16px] gilroy-b text-center text-white leading-[8] lg:leading-[10] xl:leading-[12] opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all ease-in-out duration-700'>Apps</h6>
                                </div>
                            </Link>
                        </div>
                        <div className="col-span-12 sm:col-span-6 md:col-span-1  hover:scale-90 transition-all ease-in-out duration-700">
                            <Link href="/website-development-company" className="relative">
                                ...
                                <div className="txt bg-[#000]/40 absolute top-0 left-0 w-full h-full flex items-center justify-center rounded-full overflow-hidden transition-all ease-in-out duration-1000 opacity-0 group-hover:opacity-100 group-hover:w-full scale-0 group-hover:scale-100">
                                    <h6 className='xl:text-[30px] text-[16px] gilroy-b text-center text-white leading-[8] lg:leading-[10] xl:leading-[12] opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all ease-in-out duration-700'>Website</h6>
                                </div>
                            </Link>
                        </div>
                        <div className="col-span-12 sm:col-span-6 md:col-span-1 relative lg:left-[-50%] group-hover:left-0 transition-all duration-700 hover:scale-90">
                            <Link href="/seo-company" className="relative">
                                ...
                                <div className="txt bg-[#000]/40 absolute top-0 left-0 w-full h-full flex items-center justify-center rounded-full overflow-hidden transition-all ease-in-out duration-1000 opacity-0 group-hover:opacity-100 group-hover:w-full scale-0 group-hover:scale-100">
                                    <h6 className='xl:text-[30px] text-[16px] gilroy-b text-center text-white leading-[8] lg:leading-[10] xl:leading-[12] opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all ease-in-out duration-700'>SEO</h6>
                                </div>
                            </Link>
                        </div>
                        <div className="col-span-12 sm:col-span-6 md:col-span-1 relative lg:left-[-100%] group-hover:left-0 transition-all duration-700 hover:scale-90">
                            <Link href="/logo-design-company" className="relative">
                                ...
                                <div className="txt bg-[#000]/40 absolute top-0 left-0 w-full h-full flex items-center justify-center rounded-full overflow-hidden transition-all ease-in-out duration-1000 opacity-0 group-hover:opacity-100 group-hover:w-full scale-0 group-hover:scale-100">
                                    <h6 className='xl:text-[30px] text-[16px] gilroy-b text-center text-white leading-[8] lg:leading-[10] xl:leading-[12] opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all ease-in-out duration-700'>Logo
                                        Design</h6>
                                </div>
                            </Link>
                        </div>
                ...
                <div className="grid grid-cols-12 lg:hidden block">
                    <div className="col-span-12">
                        <Slider {...settings}>
                            <div className="">
                                <Link href="/logo-design-company" className="relative">
